...
from flask import Flask, request, redirect, url_for, Blueprint, render_template, flash, jsonify, make_response
...
def analyze():
	...
	toc = time.time()
    # print(resp_obj)
    # as_list = list(resp_obj)
    # as_list["trx_id"] = trx_id
    # as_list["seconds"] = toc-tic
...
@api.route('/represent', methods=['POST'])
def represent():
